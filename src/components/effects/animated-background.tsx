...
const PALETTES = {
  dark: {
    base: [0.031, 0.043, 0.071], // ~#080b12
    c1: [0.23, 0.51, 0.96], // azul #3b82f6
    c2: [0.06, 0.72, 0.51], // verde #10b981
    w1: 0.3,
    w2: 0.2,
    vig: 0.65,
    mstr: 0.1,
  ...
  light: {
    base: [0.972, 0.976, 0.988],
    c1: [0.55, 0.71, 1.0], // azul claro
    c2: [0.55, 0.86, 0.72], // verde claro
    w1: 0.5,
    w2: 0.38,
    vig: 0.1,
    mstr: 0.18,
